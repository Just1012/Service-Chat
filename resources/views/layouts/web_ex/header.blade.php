            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    ...
                    <a href="#" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{asset('web/assets/images/unidy.png')}}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset("web/assets/images/unidy.png")}}" alt="" height="17">
                        </span>
                    </a>
                </div>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="{{asset('web/user/image/'.Auth()->user()->logo)}}" alt="Header Avatar">
                                @else
                                <img class="rounded-circle header-profile-user"
