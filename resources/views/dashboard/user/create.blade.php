                            ...
                            <div class="listjs-table" id="customerList">
                                ...
                                @else
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="firstNameinput" class="form-label"> رقم الهاتف</label>
                                        ...
                                        @if ($type_page == '')
                                            <div class="col-md-6" id="category_selection" style="display: none;">
                                                <div class="mb-3">
                                                    <h6 class="fw-semibold">الفئات</h6>
                                                    <select class="js-example-basic-multiple" multiple name="select[]">
                                                        <optgroup label="اختر الفئه">
                                                            @foreach ($category as $val)
                                                                <option value="{{ $val->id }}"
                                                                    {{ $engineerCategory->contains('category_id', $val->id) ? 'selected' : '' }}>
                                                                    {{ $val->name_ar }}
                                                                </option>
                                                            @endforeach
                                                        </optgroup>
                                            ...
                                            <div class="col-md-6" id="category_selection" style="display: none;">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="js-example-basic-multiple" multiple name="select[]">
                                                        <optgroup label="اختر الفئه">
                                                            @foreach ($category as $val)
                                                                <option value="{{ $val->id }}">{{ $val->name_ar }}
                                                                </option>
                                                            @endforeach
                                                        </optgroup>
                                                    </select>
