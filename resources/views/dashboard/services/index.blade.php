                    ...
                    <div class="page-title-box d-sm-flex mx-1 align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('service.index', $category->id) }}">الفئات</a>
                                </li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <h5 class="card-title mb-0 col-sm-8 col-md-10">قائمة الخدمات</h5>

                                <!-- Load More Buttons -->
                                <div class="hstack flex-wrap gap-2   mb-lg-0 mb-0 col-sm-2 col-md-1">
                                    <a href="{{ route('service.create', $category->id) }}"
...
@push('js')
    <script>
        ...
        var table = $('#alternative-pagination').DataTable({
             ...
             ajax: {
                url: '{{ route('service.datatable', $category->id) }}',
